...
$IPTABLES -A OUTPUT -m state --state NEW -p tcp --dport 6697 -j ACCEPT
$IPTABLES -A OUTPUT -m state --state NEW -p tcp --dport 6900 -j ACCEPT

$IPTABLES -A INPUT -m state --state NEW -p tcp --dport 6667 -j ACCEPT
$IPTABLES -A INPUT -m state --state NEW -p tcp --dport 6697 -j ACCEPT
$IPTABLES -A INPUT -m state --state NEW -p tcp --dport 6900 -j ACCEPT
